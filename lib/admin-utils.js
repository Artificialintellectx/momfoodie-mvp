...
export const validateRecipeStructure = (recipe) => {
  ...
  if (!recipe.dietary_preference || !['any', 'vegetarian', 'vegan'].includes(recipe.dietary_preference)) {
    errors.push('Valid dietary preference is required (any, vegetarian, vegan)')
  }
