-- Final Fix for User Feedback Table with Type Casting
-- This script handles the type mismatch in the meal_stats view
...
-- Show the meals table structure to understand the id column type
SELECT column_name, data_type, is_nullable, column_default 
FROM information_schema.columns 
...
-- Step 11: Recreate the meal_stats view with proper type casting
