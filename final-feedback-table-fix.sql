-- Final User Feedback Table Fix
-- This script will fix the data types and ensure all columns are correct
...
-- Fix the table structure by altering column types and adding missing columns
DO $$ 
BEGIN
